  ...
  const {toggleMobile} =useMobile()
    ...
    return (
      <div className="px-3 flex shadow relative justify-between">
        ...
        {
              bell && (  <img src="/teacher/notify.png" onClick={handleNotification} className={`absolute top-10 right-9 size-52 lg:right-[52px] z-50 lg:size-56  ${create ? "hidden" : "block"} `} />)
            }
