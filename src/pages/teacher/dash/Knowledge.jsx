                ...
                create ? (<CreateKnowledge />) : (
                    <div className='flex overflow-hidden pt-5 flex-col p-3 gap-2'>
                        <div className='flex justify-between p-2 items-center text-white'>
                            <p className='font-bold text-[18px] lg:text-[22px] text-black'>Knowledge Trail</p>
                        ...
                        <div className='p-2'>
                            <p className='font-bold text-[18px] lg:text-[22px] text-black'>Important Knowledge Trail</p>
