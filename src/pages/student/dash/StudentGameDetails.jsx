  ...
  return (
    <div className='px-3'>
      <div className='flex justify-between p-2 items-center text-white'>
        <p className='font-bold text-[16px] lg:text-[20px] text-black'>High Rating Games</p>
        <Link to={`create${param.gameType.toLocaleLowerCase()}`} className='flex cursor-pointer p-[10px] items-center rounded-2xl gap-2 bg-main-dark'>Enter Game</Link>
      </div>
